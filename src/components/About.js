    ...
    <React.Fragment>
      <div className="aboutContainer">
        <div align="center" className="upperNameHeading nameHeading">
          <span ref={upperNameHeadingRef}>Hey, I'm Lekha.</span>
        </div>
        <div className="row">
          ...
          <div className="col-md-7 col-sm-8 col">
            ...
            <div className="inlineNameHeading nameHeading">
              <span ref={inlineNameHeadingRef}>Hey, I'm Lekha.</span>
            </div>
            <p className="introductionText" ref={introductionTextRef}>
              I am a graduate Computer Science student at George Washington
              University. I am actively looking for full time SDE roles starting
              May, 2024. I have 3 years of work experience as a backend software
              developer. I love to solve new challenges everyday.
            </p>
            <span>
